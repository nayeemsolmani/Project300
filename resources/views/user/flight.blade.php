...
@section('content')
<div class ="container-fluid" id="flight">
<div class="container image">
    ...
    <div class="col-md-3">
        ...
        <div class="col-md-7 col-md-offset-2">
            <div class="panel panel-primary">
                <div class="panel-heading">Flight Ticket Booking</div>
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="/bookings">
                        ...
                        <div class="form-group">
                            <div class="col-md-6">
                                <input id="title" type="hidden" class="form-control" name="title" value="flight">
                            </div>
                        </div>
