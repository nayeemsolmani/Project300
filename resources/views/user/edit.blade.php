                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{'/user/'.$user->id}}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="lastname" type="text" value ="{{$user->lastname}}" class="form-control" name="lastname" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="accountNo" type="text" class="form-control" name="accountNo" value ="{{$user->accountNo}}" required>
                            </div>
                        </div>
